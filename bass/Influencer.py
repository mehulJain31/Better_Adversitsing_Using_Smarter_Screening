class Influencer:
    ...
    def CreateInfluencerDict(self):
        ...
        result={ "instagram_url": self.instagram_url, "username": self.username, "name":self.name, "bio": self.bio, "total_followers": self.total_followers, "max_likes": self.max_likes, "paragraph":self.paragraph,"engagement_index":self.engagement_index}
